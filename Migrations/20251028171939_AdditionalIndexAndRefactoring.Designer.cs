...
namespace ElderConnectApi.Migrations
{
    ...
    [Migration("20251028171939_AdditionalIndexAndRefactoring")]
    partial class AdditionalIndexAndRefactoring
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ElderConnectApi.Data.Entities.Booking", b =>
                {
                    ...
                    b.HasIndex(new[] { "EndTime" }, "ix_booking_end_time")
                        .HasDatabaseName("ix_bookings_end_time");
                    ...
                    b.HasIndex(new[] { "StartTime" }, "ix_booking_start_time")
